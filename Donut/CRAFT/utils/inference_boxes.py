...
def load_icdar2015_gt(dataFolder, isTraing=False, test="val"):
    ...
    for gt_path in tqdm(gt_folder_path, desc="Loading dataset"):
        ...
        for line in lines:
            ...
            cv2.polylines(
                image, [np.array(box_points).astype(np.int32)], True, (0, 0, 255), 1
            )
